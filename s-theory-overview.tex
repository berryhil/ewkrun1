...
precise definition of the independent coefficients depends upon the
...
calculable field theories, therefore care must be taken to specify,
for each experimental observable, which range is applicable.
Alternatively, different unitarization procedures
...
however, for dimension-8 EFTs to violate unitarity at the Run 1 LHC
energies and sensitivities, so the details of unitarization are 
critical in presenting and interpreting those
results.
...
elements, as well as parton-shower matching, and PDFs consistently
