...
$BR(ZZ) \to \ll\ll = 0.101^2 \cdot {4 \over 9} = 0.0045$~\cite{Agashe:2014kda}.  
...
As example a comparison of the measured and predicted differential cross sections in bins of the 
