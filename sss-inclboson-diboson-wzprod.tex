...
The ATGC parameter 95\% CL limits using a form-factor of $\Lambda=2\TeV$ and without a form-factor are quoted 
...
%\end{table}
 ...
 \begin{tabular}{ccccc}
 \caption{Expected and observed 95\% CL on \dkz, \lz\ and \gz for $\Lambda = 2\TeV$ and $\Lambda = \infty$.}\label{tab:sss-WZprod-ATGC}
	 \hline
	 \noalign{\smallskip}
	 $\Lambda_{\mathrm{co}}$  & Coupling & Expected  & Observed \\
	 	 \noalign{\smallskip}
		% &  $\Lambda = 100 $ TeV &  $\Lambda = 100 $ TeV \\
		% \noalign{\smallskip}

	 \hline
  	\noalign{\smallskip}                              %  Expected    & Observed
	\multirow{3}{*}{$2$ TeV} & $\Delta g^Z_1$                   &    [$-0.023$ ; $0.055$]  & [ $-0.029$ ; $0.050$] \\
	\noalign{\smallskip}
       &  $\Delta \kappa^Z$                                                 &    [$-0.22$ ; $0.36$]  & [ $-0.23$ ; $0.46$] \\     
        	 \noalign{\smallskip}
       & $\lambda^Z$                                                        &    [$-0.026$ ; $0.026$]  & [ $-0.028$ ; $0.028$] \\
         \noalign{\smallskip}
         \hline
	\noalign{\smallskip}
         	\multirow{3}{*}{ $ \infty$} & $\Delta g^Z_1$                 &    [$-0.016$ ; $0.032$]  & [$-0.019$ ; $0.029$] \\
	\noalign{\smallskip}
       &  $\Delta \kappa^Z$                                 &    [$-0.17$ ; $0.25$]    & [$-0.19$ ; $0.30$] \\
        	 \noalign{\smallskip}
       & $\lambda^Z$                                        &    [$-0.016$ ; $0.016$]  & [$-0.016$ ; $0.016$] \\
         \noalign{\smallskip}
	 \hline
	 \end{tabular}
